      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Design Your Own Cap</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Create a unique cap that matches your style with our interactive
              cap customizer. Choose colors, add text, and make it your own.
            </p>
          </div>
      ...
      <section className="py-12 bg-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mb-6 max-w-2xl mx-auto">
            Stay updated with the latest cap styles, exclusive offers, and
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">CapCo.</h3>
              <p className="text-gray-400">
                Premium quality caps for every style and occasion.
              </p>
            </div>
            <div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
            <p>© 2023 CapCo. All rights reserved.</p>
          </div>
        </div>
      </footer>
